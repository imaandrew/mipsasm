    ...
    for inst in insts {
        let i = match inst {
            ...
            ast::Instruction::Register { op, rs, rt, rd, sa } => match op {
                R::AbsS => 0b010001 << 26 | 0b10000 << 21 | rs.as_num() << 16 | rd.as_num() << 11 | 0b000101,
                R::AbsD => 0b010001 << 26 | 0b10001 << 21 | rs.as_num() << 16 | rd.as_num() << 11 | 0b000101,
                R::Add => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b100000,
                R::Addu => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b100001,
                R::AddS => 0b010001 << 26 | 0b10000 << 21 | rs.as_num() << 16 | rd.as_num() << 11,
                R::AddD => 0b010001 << 26 | 0b10001 << 21 | rs.as_num() << 16 | rd.as_num() << 11,
                ...
                R::Ddiv => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b011110,
                R::Ddivu => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b011111,
                R::Div => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b011010,
                R::Divu => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b011011,
                ...
                R::Dmult => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b011100,
                R::Dmultu => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | 0b011101,
                R::Dsll => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | (sa as u32) << 6 | 0b111000,
                R::Dsll32 => rs.as_num() << 21 | rt.as_num() << 16 | rd.as_num() << 11 | (sa as u32) << 6 | 0b111100,
                ...
                R::Tlbp => 0b010000 << 26 | 0b001000,
                R::Tlbr => 0b010000 << 26 | 0b000001,
                R::Tlbwi => 0b010000 << 26 | 0b000010,
                R::Tlbwr => 0b010000 << 26 | 0b000110,
